...
camera_config_t esp32cam_config{
    ...
    // .frame_size = FRAMESIZE_SXGA, // needs 160K for framebuffer width=1024, height=768
    // .frame_size = FRAMESIZE_XGA, // needs 96K or even smaller width=1024, height=768 max .jpeg_quality = 20 .fb_count = 1 FRAMESIZE_SVGA - can work if using only 1 fb
     .frame_size = FRAMESIZE_SVGA, // FRAMESIZE_SVGA - can work if using only 1 fb width=800, height=600  max .jpeg_quality = 11 .fb_count = 2 
    // .frame_size = FRAMESIZE_VGA, // width=640, height=480 max .jpeg_quality = 6 .fb_count = 2
     //.frame_size = FRAMESIZE_QVGA, //width=320, height=240 max .jpeg_quality = 2 .fb_count = 2
    .jpeg_quality = 11, //0-63 lower numbers are higher quality
